...
import {
    ...
    checkSecondPillow,
    chooseSecondPillowColor,
    countSecondPillowCost,
} from '../../../../js/actions';
        ...
        const blockOfColors = pillowColors.map((item, index) => {
            return (
                <div
                    ...
                    onClick={() => this.chooseColorForSecondPillow(item.color, item.name)}
                ></div>
            );
        });
            ...
            <tr>
                ...
                <td className="order__block">
                    <div className="order__block__colors">
                        <button
                            ...
                            onClick={this.showColorsOfSecondPillow}
                            style={{backgroundColor: this.state.secondPillowColor}}
                        ></button>
                ...
                <td className="order__block">
                    <input
                        ...
                        value={countOfSecondPillow}
                        type="number"
                        min="0"
                        max="10000"
                        onChange={this.toChangeCountOfSecondPillow}
                    ></input>
                </td>
                ...
                <td className="order__block">
                    <input
                        type="checkbox"
                        checked={isSecondPillowChecked}
                        onChange={() => this.toCheckSecondPillow(secondPillowPrice)}
                    />
                </td>
            </tr>
        );
