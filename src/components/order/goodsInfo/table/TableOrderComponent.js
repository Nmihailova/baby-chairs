        ...
        return (
            <table cols="5">
                <tbody>
                    ...
                    <FirstPillow
                        toCountCostOfChair={this.toCountCostOfChair}
                        firstPillowPrice={this.state.firstPillowPrice}
                    />
                    <SecondPillow
                        toCountCostOfChair={this.toCountCostOfChair}
                        secondPillowPrice={this.state.secondPillowPrice}
                    />

                    <tr>
                        <td className="order__footer order__footer_text" colSpan="3">
                            Итого:
                        </td>
