            ...
            <div className="order">
                ...
                <div className="order__info">
                    ...
                    <input
                        ...
                        placeholder="Дом"
                        onChange={this.houseNumberChange}
                    />
                    <input
                        className="order__info__input"
                        value={this.state.flatNumber}
                        placeholder="Квартира"
                        onChange={this.flatNumberChange}
                    />
                ...
                <div className="order__delivery">
                    ...
                    <div>
                        <label>
                            <input
                                type="radio"
                                value="Курьер"
                                checked={this.state.deliveryMethod === 'Курьер'}
                    ...
                    <div>
                        <label>
                            <input
                                type="radio"
                                value="Почта России"
                                checked={this.state.deliveryMethod === 'Почта России'}
                                onChange={this.chooseDeliveryMethod}
                            />
                            Почта России
                        </label>
                    ...
                    <div>
                        <label>
                            <input
                                type="radio"
                                value="Доставка по России и СНГ транспортными компаниями"
                                checked={
                                    this.state.deliveryMethod === 'Доставка по России и СНГ транспортными компаниями'
                                }
                                onChange={this.chooseDeliveryMethod}
                            />
                ...
                <button className="order__order-btn" type="submit" onClick={this.makeOrder}>
                    Заказать
                </button>
            </div>
        );
