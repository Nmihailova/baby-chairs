        ...
        return (
            <Fragment>
                {!this.state.isFeedbackFormShown && (
                    <button className="feedback__btn" onClick={this.showFeedBackForm}>
                        Оставить отзыв
                    </button>
                )}
                {this.state.isFeedbackFormShown && (
                    <div className="feedback__form">
                        <input
                            className="feedback__form__name"
                            value={this.state.authorName}
                            onChange={this.changeAuthorName}
                            placeholder="Ваше имя"
                        />
                        <input
                            className="feedback__form__city"
                            value={this.state.residenceCity}
                            onChange={this.changeResidenceCity}
                        ...
                        <label>
                            ...
                            <textarea
                                className="feedback__form__text"
                                rows="10"
                                cols="68"
                        ...
                        <button className="feedback__form__btn" onClick={this.leaveFeedback}>
                            Отправить отзыв
                        </button>
                    </div>
                )}
